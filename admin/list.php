                    ...
                    <?php if (count($users) > 0) : ?>
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                <td>
                                    <img src="<?php
                                        $pic = !empty($user['PROFILE_PIC']) ? $user['PROFILE_PIC'] : 'images/default_pic.png';
                                        echo (strpos($pic, 'uploads/') === 0 || strpos($pic, 'images/') === 0 ? '../' : '') . htmlspecialchars($pic);
                                    ?>" alt="User Profile" style="width: 70px; height: 70px; border-radius: 50%; object-fit: cover;">
                                </td>
