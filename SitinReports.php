    ...
    <div style="margin-left:20%; z-index: 1; position: relative;">
        ...
        <div class="w3-container" style="margin: 5% 10px;">
            ...
            <div class="export-buttons">
                ...
                ?>
                <a href="?<?php echo $filter_query; ?>" class="w3-button w3-green w3-round-large">Export to CSV</a>
                <a href="?<?php echo $excel_query; ?>" class="w3-button w3-blue w3-round-large">Export to Excel</a>
                <a href="?<?php echo $pdf_query; ?>" class="w3-button w3-red w3-round-large">Export to PDF</a>
            </div>
