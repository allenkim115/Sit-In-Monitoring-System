...
include '../notifications/notification_functions.php';
session_start();
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width:20%;" id="mySidebar">
    ...
    <div class="profile w3-center w3-margin w3-padding">
        ...
        ?>
        <img src="<?php echo (strpos($profile_pic, 'uploads/') === 0 ? '../' : '') . htmlspecialchars($profile_pic); ?>" alt="profile_pic" style="width: 90px; height:90px; border-radius: 50%; border: 2px solid rgba(100,25,117,1);">
    </div>
    ...
    <div id="profile" class="w3-modal" style="z-index: 1000;">
        <div class="w3-modal-content w3-animate-zoom w3-round-xlarge" style="width: 30%;">
            ...
            <div class="display_photo w3-container w3-center">
                <img src="<?php echo (strpos($profile_pic, 'uploads/') === 0 ? '../' : '') . htmlspecialchars($profile_pic); ?>" alt="profile_pic" style="width: 120px; height:120px; border-radius: 50%; border: 2px solid rgba(100,25,117,1);">
            </div>
